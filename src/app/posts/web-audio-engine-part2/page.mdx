...
You can find the branch related to this post here: [https://github.com/mikezaby/web_audio_engine/tree/basic-module](https://github.com/mikezaby/web_audio_engine/tree/basic-module)
