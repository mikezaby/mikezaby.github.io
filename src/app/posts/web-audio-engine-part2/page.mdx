...
After we will proceed to the implementation of the abstract class `Module`.
To support our data-driven approach, we have to implement two functions, `props` and `serialize`.
...
- serialize: this function returns the data of the module instance, and the data-structure of this is the IModule.
