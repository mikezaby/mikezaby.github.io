...
export const metadata = {
  ...
  description:
    "This is the story about how I started be involved with audio programming, and the first part of a series of posts about how to implement an data-driven audio engine with web audio",
  date: "Mar 28, 2024",
  cover: CoverImg,
};
